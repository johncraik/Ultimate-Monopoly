...
/// <see cref="FreeParkingAmount"/> is the live Free Parking pot total.
/// </summary>
public record BoardViewModel(Board Board, List<PropertyModel> Properties, List<(UserProfileViewModel Profile, PlayerModel Model)> Players, uint FreeParkingAmount);