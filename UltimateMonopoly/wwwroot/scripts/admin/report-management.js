// Report Management — AJAX filter / search / pagination over the _ReportsTable partial.
// The resolution radio and the search box re-fetch the table; pagination links are upgraded from a
// full-page reload (the no-JS fallback) to a partial fetch. Plus click-to-copy on the ids.
(function () {
    ...
    function tableUrl(page) {
        ...
        params.set('Resolution', fd.get('Resolution') || 'Open');
    ...
    // Resolution radio → re-fetch from page 1.
    ...
    // Click-to-copy the (truncated) report / user id; flashes "Copied!".
